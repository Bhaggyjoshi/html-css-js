let superheroes = [  
  ...
  viewSuperhero=(id)=> {
    ...
    document.getElementById('superhero-image').src = superhero.images.lg;

    document.getElementById('superhero-name').innerText = superhero.name;

    document.getElementById('superhero-gender').innerText = superhero.appearance.gender;

    document.getElementById('superhero-height').innerText = superhero.appearance.height;

    document.getElementById('superhero-weight').innerText = superhero.appearance.weight;

    document.getElementById('superhero-eye').innerText = superhero.appearance.eyeColor;

    document.getElementById('superhero-hair').innerText = superhero.appearance.hairColor;

    document.getElementById('superhero-fullname').innerText = superhero.biography.fullName;

    document.getElementById('superhero-ego').innerText = superhero.biography.alterEgos;

    document.getElementById('superhero-firstappear').innerText = superhero.biography.firstAppearance;

    document.getElementById('superhero-publisher').innerText = superhero.biography.publisher;

    document.getElementById('superhero-groupaff').innerText = superhero.connections.groupAffiliation;

    document.getElementById('superhero-relatives').innerText = superhero.connections.relatives;

    document.getElementById('superhero-intelligence').style.width= superhero.powerstats.intelligence+"%";

    document.getElementById('superhero-speed').style.width= superhero.powerstats.speed+"%";

    document.getElementById('superhero-durability').style.width= superhero.powerstats.durability+"%";

    document.getElementById('superhero-power').style.width= superhero.powerstats.power+"%";

    document.getElementById('superhero-strength').style.width= superhero.powerstats.strength+"%";
    
    document.getElementById('superhero-combat').style.width= superhero.powerstats.combat+"%";
  }
...
// publisher extraction code
  ...
  goToPage= () =>{
    let pageNo = Number(document.getElementById('goto').value);
    if(pageNo !== "" && (pageNo > 1 && pageNo < noOfPages)){
      start = (pageNo-1)*12;
      pageCount = pageNo;
      display(tempSuperheroes)
    }
  ...
  display=(superarray)=>{
    ...
    let cloneSuperArray = [...superarray];

    let diSuperheroes = cloneSuperArray.splice(start, 12);
    

    diSuperheroes.forEach((superhero,index)=>{
      ...
      superheroString+= `
                ...
                <div class="superhero" >
                        <div class="super-img">
                            <img class="supimg" src="${superhero.images.md}" alt="superhero" onclick="viewSuperhero(${superhero.id})">
                        </div>

                    <div class="super-details">
                            <h1 class="super-name">${superhero.name} ${superhero.id}</h1>
                            ...
                            <div class="powerstats">
                                <div>
                                      ...
                                      <span class="power-bg">
                                      <span class="power-fg" style="width:${superhero.powerstats.intelligence}%"></span>
                                      </span>
                                </div>
                                ...
                                <div>
                                      ...
                                      <span class="power-bg">
                                      <span class="power-fg" style="width:${superhero.powerstats.speed}%"></span>
                                      </span>
                                </div>
                                <div>
                                      <p>Durability: ${superhero.powerstats.durability}</p>
                                      <span class="power-bg">
                                      <span class="power-fg" style="width:${superhero.powerstats.durability}%"></span>
                                      </span>
                                </div>
                                <div>
                                      <p>Power: ${superhero.powerstats.power}</p>
                                      <span class="power-bg">
                                      <span class="power-fg" style="width:${superhero.powerstats.power}%"></span>
                                      </span>
                                </div>
                                <div>
                                      <p>Strength: ${superhero.powerstats.strength}</p>
                                      <span class="power-bg">
                                      <span class="power-fg" style="width:${superhero.powerstats.strength}%"></span>
                                      </span>
                                </div>
                    <div>
                    <p>Combat: ${superhero.powerstats.combat}</p>
                    <span class="power-bg">
                    <span class="power-fg" style="width:${superhero.powerstats.combat}%"></span>
                    </span>
              </div>
                            </div>
  ...
  document.getElementById('superheroes1').innerHTML = superheroString;
  // console.log(superheroes1);

  document.getElementById('current').innerText = `${pageCount} page from ${noOfPages}`;
  
}
display(tempSuperheroes);

// filter state management
// what filter are applied or not

let filters = {
  // here we are applying filter then status is true otherwise false, currently inactive
  ...
  // sortProperty:{active:false, value:""},
  // sortType:{active:false, value:""}


}
// it's a function which manipulate the filter object
...
applyNameFilter=(filtername , value) =>{
  ...
  // console.log(filters)
  applyFilters(); //start typing this function is called
}
...
// minIntelligence filter logic
if(filters.minIntelligence.active === true)
  {
      tempSuperheroes = tempSuperheroes.filter((superhero, index) =>{
          return Number(superhero.powerstats.intelligence[1].split(" ")[0]) >= Number(filters.minIntelligence.value);
  })
}

// maxIntelligence filter logic
if(filters.maxIntelligence.active === true)
  {
      tempSuperheroes = tempSuperheroes.filter((superhero, index) =>{
          return  Number(superhero.powerstats.intelligence[1].split(" ")[0]) <= Number(filters.maxIntelligence.value);
  })
}


noOfPages = Math.ceil(tempSuperheroes.length/12);
pageCount = 1;
display(tempSuperheroes);
...
cancelFilters=()=>{
  ...
  document.getElementById('count').innerText = tempSuperheroes.length;
   ...
   sorting=()=>{
    // .... -> spreadoperator works with array - gives the value of array without array format
    // let sortArray =[...tempSuperheroes];
